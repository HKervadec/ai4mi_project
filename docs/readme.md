...
![Example of the viewer on the TOY example](img/viewer_toy.png)
...
<!-- ![Example of the viewer on SegTHOR](img/viewer_segthor.png) -->
...
![Viewing the prediction without smoothing](img/3dslicer_zoom.png)
...
![Validation DSC](img/dice_val.png)
